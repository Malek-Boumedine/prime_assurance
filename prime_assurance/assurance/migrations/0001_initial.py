    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('physique', 'Physique'), ('telephone', 'Téléphone'), ('visio', 'Visio')], max_length=100, null=True)),
                ('operateur', models.ForeignKey(limit_choices_to={'is_operateur': True}, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
